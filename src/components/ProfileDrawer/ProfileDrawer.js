        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          {options.map((opt) => {
            ...
            return (
              ...
              >
                <Text
                  style={[ps.optionText, sel && ps.optionTextActive]}
                  numberOfLines={1}
                >
                  {opt}
                </Text>
...
export const ProfileDrawer = () => {
  ...
  const menuItems = [
    ...
    },
    {
      label: "Efforts Log",
      route: "Efforts",
      icon: (c) => <Flame size={18} color={c} />,
    },
    {
      label: "Results & Trends",
      route: "Results",
      icon: (c) => <BarChart2 size={18} color={c} />,
    },
    {
    ...
    },
    {
      label: "Support & Help",
      route: "Support",
      icon: (c) => <MessageSquare size={18} color={c} />,
    },
  ];
    ...
    if (userId) {
      try {
        ...
        if (res.ok && json.status === "success" && json.data) {
          ...
          if (d.meal_preference || d.mealPreference || d.diet)
            currMeal = d.meal_preference || d.mealPreference || d.diet;
  ...
  const handleSave = async () => {
    ...
    if (editAge && isNaN(parseInt(editAge, 10))) {
      Alert.alert("Validation", "Age must be a number.");
      return;
    }
    if (editHeight && isNaN(parseFloat(editHeight))) {
      Alert.alert("Validation", "Height must be a number.");
      return;
    }
    ...
    if (editHeight !== (height ? String(height) : ""))
    ...
    try {
      ...
      let success = false;
      const updateUrl =
        "https://sbm-mobile-app-906714478.development.catalystserverless.com/server/user_profile_update";
      ...
      Alert.alert(
        "✅ Profile Updated",
        "Your profile details have been updated in the Data Store.",
  ...
  return (
    <>
      ...
      >
        <View
          style={[
            ...
            isWebDesktop && drawerStyles.webOverlay,
          ]}
        >
          <Animated.View
            style={[
          ...
          >
            ...
            >
                  ...
                  {menuItems.map((item) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                        style={[
                          drawerStyles.drawerNavItem,
                          isActive && drawerStyles.activeNavItem,
                        ]}
                        onPress={() => handleNavClick(item.route)}
                      >
                        <View style={drawerStyles.navItemIcon}>
                          {item.icon(iconColor)}
                        </View>
                        <Text
                          style={[
                            drawerStyles.navItemLabel,
                            isActive && drawerStyles.activeNavLabel,
                          ]}
                        >
                          {item.label}
                        </Text>
              ...
              <View style={drawerStyles.drawerDetailsSection}>
                <Text style={drawerStyles.drawerSectionLabel}>
                  Account Details
                </Text>
                <View style={drawerStyles.drawerDetailsCard}>
                  {[
                    ...
                    {
                      icon: <Scale size={14} color={theme.colors.textMuted} />,
                      label: "Weight / Goal",
                      val: `${loggedWeight} kg (${userGoal})`,
                    },
                    {
                      icon: <User size={14} color={theme.colors.textMuted} />,
                      label: "Gender / Age / Height",
                      val: `${gender} / ${age} yrs / ${height} cm`,
                    },
                    {
                      icon: (
                    ...
                    {
                      icon: <Globe size={14} color={theme.colors.textMuted} />,
                      label: "Time Zone",
                      val: timezone,
                    },
                  ].map((row, i, arr) => (
                    <View
                      key={row.label}
                      style={[
                        drawerStyles.drawerMetaRow,
                        i < arr.length - 1 && ms.rowBorder,
                      ]}
                    >
                      ...
                      <View style={drawerStyles.metaTexts}>
                        ...
                        <Text style={drawerStyles.metaValue} numberOfLines={1}>
                          {row.val}
                        </Text>
                      </View>
                    </View>
              ...
              <View style={drawerStyles.drawerLogoutWrapper}>
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={drawerStyles.drawerLogoutBtn}
                  onPress={logoutUser}
                >
          ...
          <View style={ms.editSheet}>
            ...
            >
              ...
              <View style={ms.fieldBlock}>
                ...
                >
                  <Text style={ms.pickerBtnText} numberOfLines={1}>
                    {editGoal || "Select goal"}
                  </Text>
              ...
              <View style={ms.fieldBlock}>
                <View style={ms.fieldLabelRow}>
                  ...
                  <View
                    style={[ms.tzBadge, tzRemaining === 0 && ms.tzBadgeRed]}
                  >
                    <AlertTriangle
                      size={9}
                      color={tzRemaining === 0 ? "#FF5252" : "#FFD600"}
                    />
                    <Text
                      style={[
                        ms.tzBadgeText,
                        tzRemaining === 0 && ms.tzBadgeTextRed,
                      ]}
                    >
                      {tzRemaining === 0
                        ? "Limit reached"
                ...
                <TouchableOpacity
                  style={[
                    ms.pickerBtn,
                    tzRemaining === 0 && ms.pickerBtnDisabled,
                  ]}
                  activeOpacity={0.8}
                  onPress={() => {
                    if (tzRemaining <= 0) {
                      Alert.alert(
                        "⏳ Limit Reached",
                        "You can only change your timezone 2 times per month.",
                      );
                    } else {
                      setTzOpen(true);
                    }
                ...
                >
                  <Text
                    style={[
                      ms.pickerBtnText,
                      tzRemaining === 0 && ms.pickerBtnTextDisabled,
                    ]}
                    numberOfLines={1}
                  >
              ...
              <View style={ms.tzNote}>
                <Text style={ms.tzNoteText}>
                  ...
                  <Text style={{ color: "#B085F5", fontWeight: "700" }}>
                    2 times per month
                  </Text>{" "}
      ...
      <BottomPicker
        ...
        selectedValue={editMeal}
        onSelect={setEditMeal}
...
const ms = StyleSheet.create({
  ...
  tzNote: {
    ...
    padding: 12,
    borderWidth: 1,
    borderColor: "rgba(176,133,245,0.18)",
    marginBottom: 4,
  },
  tzNoteText: {
    fontSize: 11,
